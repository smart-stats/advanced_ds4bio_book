...
The output looks like this. Hoover over a bar to test. (Look at the file in `d3/roi1.html`)
...
Here's the scatterplot that I've got so far. For HW, add axis labels and make it so that it displays the subject ID when you hoover over a point! 
